...
import com.fph.appnavigationlib.utils.ViewUtil;
...
public class BindChildValue implements BindChildValueImp {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.fph.BindChildValueImp#getChildView()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.fph.BindChildValueImp#getViewById(int)
	 */
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#setChildView(android.
	 * view.View)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#bindChildText(int,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.fph.BindChildValueImp#bindChildUrl(int,
	 * java.lang.String)
	 */
	@Override
	...
	public BindChildValueImp bindChildUrl(int resId, String charSequence, int waitDrawableId, int errorDrawableId) {
		ViewUtil.bindView(getViewById(resId), charSequence, waitDrawableId, errorDrawableId);
		return this;
	}
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#bindChildVisible(int,
	 * int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#bindChildDrawable(int,
	 * int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#bindChildLinkify(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#bindChildEnable(int,
	 * boolean)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#bindChildCheckable(
	 * int, boolean)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.fph.BindChildValueImp#bindChildClickable(
	 * int, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildTextColor(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildTextColor(int, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildTextSize(int, float)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildOnCheckedChangeListener(int, android.widget.CompoundButton.OnCheckedChangeListener)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildOnCheckedChangeListener(int, android.widget.RadioGroup.OnCheckedChangeListener)
	 */
	@Override
	public BindChildValueImp bindChildOnCheckedChangeListener(int resId,
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#getWeakContext()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChilddTextChangedListener(int, android.text.TextWatcher)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildOnTouchListener(int, android.view.View.OnTouchListener)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildTag(int, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildUrl(int, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildUrl(int, java.lang.String, int, int, java.lang.String)
	 */
	@Override
	public BindChildValueImp bindChildUrl(int resId, String charSequence, int waitDrawableId, int errorDrawableId,
										  String valueFix) {
	...
	/* (non-Javadoc)
	 * @see com.fph.BindChildValueImp#bindChildChecked(int, boolean)
	 */
	@Override
