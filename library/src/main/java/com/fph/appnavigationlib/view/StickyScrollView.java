...
import com.fph.appnavigationlib.listener.ObjectListener;
...
/**
 * 
 * 控制scrollview 指定view悬浮
 * 
 * com.fph.StickyScrollView.java
 * 
 * Created by wang on 2016上午9:35:46 
 * 
 * Tips:tag=sticky-nonconstant-hastransparancy||sticky
 */
public class StickyScrollView extends ScrollView {
	...
	/**
	 * @param stickyViews the stickyViews to set
	 */
	public void setStickyViews(ArrayList<View> stickyViews) {
		this.stickyViews = stickyViews;
	}
	...
	public StickyScrollView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
    		...
    		a.recycle();
     	    getViewTreeObserver().addOnGlobalLayoutListener(new StickyScrollViewOnGlobalLayoutListener(this,new ObjectListener() {
				@Override
	...
	/**
	 * @return the objectListenerImp
	 */
	public ObjectListenerImp getObjectListenerImp() {
		return objectListenerImp;
	}

	/**
	 * @param objectListenerImp the objectListenerImp to set
	 */
	public void setObjectListenerImp(ObjectListenerImp objectListenerImp) {
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if (isEnd && objectListenerImp!=null) {
			if (isZero) {
				objectListenerImp.onScrollChanged(this, l, t, oldl, oldt);
			}
			if (getScrollY()==0) {
				isZero=true;
			}
